    ...
    def on_timeline_event(event: dict[str, Any]):
        ...
        if action == "baseline":
            ...
            bgp_gen.emit_update(
                ...
                scenario={"name": scenario_name, "attack_step": "subprefix_announce", "incident_id": incident_id}
            )
            syslog_gen.emit(
            ...
            syslog_gen.emit(
                ...
                subsystem="routing",
                peer_ip=None,
                scenario={"name": scenario_name, "attack_step": "intercept_active", "incident_id": incident_id}
            )
            ...
            latency_gen.emit(
                ...
                scenario={"name": scenario_name, "attack_step": "latency_anomaly", "incident_id": incident_id}
            )
            syslog_gen.emit(
            ...
            syslog_gen.emit(
                ...
                subsystem="bgp",
                peer_ip=None,
                scenario={"name": scenario_name, "attack_step": "maintain", "incident_id": incident_id}
            )
            ...
            bgp_gen.emit_withdraw(
                ...
                scenario={"name": scenario_name, "attack_step": "withdrawal", "incident_id": incident_id}
            )
            syslog_gen.emit(
            ...
            latency_gen.emit(
                ...
                jitter_ms=2.1,
                packet_loss_pct=0.0,
                scenario={"name": scenario_name, "attack_step": "restoration", "incident_id": incident_id}
            )
