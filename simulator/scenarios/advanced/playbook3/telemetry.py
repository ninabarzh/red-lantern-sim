            ...
            event_bus.publish(
                {
                    ...
                    "timestamp": clock.now(),
                    "source": {
                        "feed": "test-infrastructure",
                        "observer": entry.get("test_source"),
                    },
                    "attributes": {
            ...
            event_bus.publish(
                {
                    ...
                    "attributes": {
                        ...
                        "regions_not_intercepted": entry.get(
                            "regions_not_intercepted", []
                        ),
            ...
            event_bus.publish(
                {
                    ...
                    "timestamp": clock.now(),
                    "source": {
                        "feed": "netflow-collector",
                        "observer": "victim-network",
                    },
                    "attributes": {
            ...
            event_bus.publish(
                {
                    ...
                    "attributes": {
                        ...
                        "monitor_abuse_complaints": entry.get(
                            "monitor_abuse_complaints"
                        ),
            ...
            event_bus.publish(
                {
                    ...
                    "attributes": {
                        ...
                        "public_monitoring_alerts": entry.get(
                            "public_monitoring_alerts"
                        ),
                        "victim_investigation": entry.get(
            ...
            event_bus.publish(
                {
                    ...
                    "attributes": {
                        "prefix": prefix,
                        "legitimate_path_restored": entry.get(
                            "legitimate_path_restored"
                        ),
                        "via_as": entry.get("via_as"),
                        "reconvergence_time_seconds": entry.get(
                            "reconvergence_time_seconds"
                        ),
                    },
                    "scenario": {
                        "name": scenario_name,
            ...
            event_bus.publish(
                {
                    ...
                    "attributes": {
                        ...
                        "control_plane_attack_confirmed": entry.get(
                            "control_plane_attack_confirmed"
                        ),
                        "detection_during_operation": entry.get(
                            "detection_during_operation"
                        ),
